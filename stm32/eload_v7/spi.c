...
#if MY_ADDRESS == 17
	// 17
	const int32_t kc = 120381;
	const int32_t kr = 142712;
	const int32_t kv = 341384;
	const int32_t ac = 0;
	const int32_t ar = 0;
	const int32_t av = 512918;
	const uint32_t temp_sens_addr = 0x80;
#endif
#if MY_ADDRESS == 18
	// 18
	const int32_t kc = 119497;
	const int32_t kr = 143769;
	const int32_t kv = 305228;
	const int32_t ac = 0;
	const int32_t ar = 0;
